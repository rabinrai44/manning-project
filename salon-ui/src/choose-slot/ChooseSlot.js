...
class ChooseSlot extends Component {
  ...
  showSlotsOnDate() {
    ...
    if (isDateLessThanToday(slotDate)) {
    ...
    const url =
      API_URL + "slots/retrieveAvailableSlots/" + serviceId + "/" + slotDate;
  ...
  render() {
    ...
    return (
      <div>
        <div className="row">
          ...
          <div className="col-3">
            ...
            <button
              ...
              onClick={(evt) => this.showSlotsOnDate()}
            >
              Show Slots
            </button>
          </div>
        ...
        {slots.length > 0 && (
          <h4 className="pt-5">
            Available Slots on {slotDate} <br />{" "}
          </h4>
        )}
            ...
            return (
              <div key={index} className="card mb-4 shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <button
                    type="button"
                    onClick={(evt) => this.bookSlotFor(item)}
